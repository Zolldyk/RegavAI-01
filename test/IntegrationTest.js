...
const MOCK_MARKET_SCENARIOS = {
  BULLISH_BREAKOUT: {
    ...
    indicators: {
      rsi: { '1m': 65, '5m': 68 },
      macd: { line: 8, signal: 5, histogram: 3, trend: 'BULLISH_CROSSOVER' },
  ...
  BEARISH_BREAKDOWN: {
    ...
    indicators: {
      rsi: { '1m': 25, '5m': 22 },
      macd: { line: -6, signal: -3, histogram: -3, trend: 'BEARISH_CROSSOVER' },
  ...
  HIGH_VOLATILITY: {
    ...
    indicators: {
      rsi: { '1m': 45, '5m': 55 },
      macd: { line: 3, signal: -2, histogram: 5, trend: 'VOLATILE' },
  ...
  describe('Error Recovery and Resilience', () => {
    test('should recover from network interruptions', async () => {
      ...
      const unreliableRecallClient = {
        ...recallClient,
        addObject: jest.fn().mockImplementation(async (..._args) => {
          networkCallCount++;
