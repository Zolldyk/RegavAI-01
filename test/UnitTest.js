...
const mockAdvancedIndicators = {
    rsi: { '1m': 45, '5m': 48 },
    macd: { line: 5, signal: 3, histogram: 2, signal: 'BULLISH_CROSSOVER' },
...
describe('TradingStrategy Unit Tests', () => {
        ...
        test('should generate BUY signal with high confidence', () => {
            ...
            const mockParams = {
                ...
                indicators: {
                    ...
                    macd: { line: 10, signal: 5, histogram: 5, signal: 'BULLISH_CROSSOVER' }
                },
                orderBook: {
        ...
        test('should generate SELL signal with bearish conditions', () => {
            ...
            const mockParams = {
                ...
                indicators: {
                    ...
                    macd: { line: -8, signal: -3, histogram: -5, signal: 'BEARISH_CROSSOVER' }
                },
                orderBook: {
                    ...mockOrderBookAnalysis,
    ...
    describe('Error Handling', () => {
        test('should handle missing market data gracefully', async () => {
            ...
            const result = await tradingStrategy._processEnhancedTradingPair('BTC/USDT', {});
