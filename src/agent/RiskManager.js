...
export class RiskManager extends EventEmitter {
     ...
     */
    adjustPositionSize(pair, baseSize, marketData) {
        try {
     ...
     */
    _calculateRiskScore(totalRisk, maxSingleRisk) {
        try {
            let score = 0;
     ...
     * @param {string} reason - Reason for closing
     */
    _updatePerformanceMetrics(pnl, reason) {
        try {
        ...
        return {
            ...
            portfolio: {
                ...
                dailyReturn: this.dailyStartBalance > 0 ? 
                    (this.dailyPnL / this.dailyStartBalance) * 100 : 0
            },
