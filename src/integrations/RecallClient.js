// ============ Imports ============
import { RecallAgentToolkit } from '@recallnet/agent-toolkit';
...
class RecallClient extends EventEmitter {
    ...
    async _initializeToolkit() {
        try {
            // ============ Load Encrypted Wallet Credentials ============
            const walletConfig = await this._loadWalletCredentials();
            ...
            logger.error('Failed to initialize Recall Agent Toolkit', { error: error.message });
            throw error;
        }
    }
